...
if __name__ == '__main__':
    ...
    al.set_evidence('okay')
    probs = VE(car, bv, [cs, al])
    print('P(bv = strong|cs=okay, al=okay) = {} '
          'P(bv = weak|cs=okay, al=okay) = {} '
          'P(bv = dead|cs=okay, al=okay) = {}'.format(probs[0], probs[1], probs[2]))

    print("===============Test===========")
    cs.set_evidence('okay')
    probs = VE(car, bv, [cs])
    print('P(bv = strong|cs=okay) = {} P(bv = weak|cs=okay) = {} P(bv = dead|cs=okay) = {}'.format(probs[0], probs[1], probs[2]))

    print("===============Question 2-b===========")
    print("===============Testing Independence===========")
    cs.set_evidence('okay')
    probs = VE(car, ba, [cs])
    print('P(ba = new|cs=okay) = {} '
          'P(ba = old|cs=okay) = {} ' 
          'P(ba = very_old|cs=okay) = {} '.format(probs[0], probs[1], probs[2]))

    cs.set_evidence('faulty')
    probs = VE(car, ba, [cs])
    print('P(ba = new|cs=faulty) = {} '
          'P(ba = old|cs=faulty) = {} '
          'P(ba = very_old|cs=faulty) = {} '.format(probs[0], probs[1], probs[2]))

    ba.set_evidence('new')
    probs = VE(car, cs, [ba])
    print('P(cs = okay|ba=new) = {} '
          'P(cs = faulty|ba=new) = {} '.format(probs[0], probs[1]))

    ba.set_evidence('old')
    probs = VE(car, cs, [ba])
    print('P(cs = okay|ba=old) = {} '
          'P(cs = faulty|ba=old) = {} '.format(probs[0], probs[1]))

    ba.set_evidence('very_old')
    probs = VE(car, cs, [ba])
    print('P(cs = okay|ba=very_old) = {} '
          'P(cs = faulty|ba=very_old) = {} '.format(probs[0], probs[1]))

    print('==========Testing Dependence===========')
    bv.set_evidence('strong')
    cs.set_evidence('okay')
    probs = VE(car, ba, [bv, cs])
    print('P(ba = new|bv=strong, cs=okay) = {} '
          'P(ba = old|bv=strong, cs=okay) = {} '
          'P(ba = very_old|bv=strong, cs=okay) = {} '.format(probs[0], probs[1], probs[2]))

    bv.set_evidence('strong')
    probs = VE(car, ba, [bv])
    print('P(ba = new|bv=strong) = {} '
          'P(ba = old|bv=strong) = {} '
          'P(ba = very_old|bv=strong) = {} '.format(probs[0], probs[1], probs[2]))

    print("===============Question 2-c===========")
    print("===============Showing Increase===========")

    print('P(st=true) = 0.28 ')

    cc.set_evidence('true')
    probs = VE(car, st, [cc])
    print('P(st = true|cc=true) = {} '.format(probs[0]))

    cc.set_evidence('true')
    fs.set_evidence('okay')
    probs = VE(car, st, [cc, fs])
    print('P(st = true|cc=true, fs=okay) = {} '.format(probs[0]))

    cc.set_evidence('true')
    fs.set_evidence('okay')
    sq.set_evidence('good')
    probs = VE(car, st, [cc, fs, sq])
    print('P(st = true|cc=true, fs=okay, sq=good) = {} '.format(probs[0]))

    cc.set_evidence('true')
    fs.set_evidence('okay')
    sq.set_evidence('good')
    asys.set_evidence('okay')
    probs = VE(car, st, [cc, fs, sq, asys])
    print('P(st = true|cc=true, fs=okay, sq=good, asys=okay) = {} '.format(probs[0]))
    ...
    probs = VE(car, st, [cc, fs, sq, asys, tm])
    print('P(st = true|cc=true, fs=okay, sq=good, asys=okay, tm=good) = {} '.format(probs[0]))

    print("===============Question 2-d===========")
    print("===============Showing Decrease===========")

    print('P(st=false) = 0.72 ')

    cc.set_evidence('true')
    probs = VE(car, st, [cc])
    print('P(st = false|cc=true) = {} '.format(probs[1]))

    cc.set_evidence('true')
    fs.set_evidence('okay')
    probs = VE(car, st, [cc, fs])
    print('P(st = false|cc=true, fs=okay) = {} '.format(probs[1]))

    cc.set_evidence('true')
    fs.set_evidence('okay')
    sq.set_evidence('good')
    probs = VE(car, st, [cc, fs, sq])
    print('P(st = false|cc=true, fs=okay, sq=good) = {} '.format(probs[1]))
    ...
    asys.set_evidence('okay')
    probs = VE(car, st, [cc, fs, sq, asys])
    print('P(st = false|cc=true, fs=okay, sq=good, asys=okay) = {} '.format(probs[1]))
    ...
    tm.set_evidence('good')
    probs = VE(car, st, [cc, fs, sq, asys, tm])
    print('P(st = false|cc=true, fs=okay, sq=good, asys=okay, tm=good) = {} '.format(probs[1]))
